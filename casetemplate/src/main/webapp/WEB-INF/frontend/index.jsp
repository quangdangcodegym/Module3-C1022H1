                                    ...
                                    <div class="row align-items-center">
                                       <!--logo start-->
                                        <div class="col-lg-3 col-md-3">
                                            <div class="logo">
                                                <a href="index.jsp"><img src="/frontend/assets\img\logo\logo.jpg.png" alt=""></a>
                                            </div>
                                        </div>
                                        <!--logo end-->
                                    ...
                                    <div class="new_product_area">
                                        ...
                                        <div class="row">
                                            <div class="product_active owl-carousel">
                                                <c:forEach var="phone" items="${requestScope.productListPhone}">
                                                    <div class="col-lg-3">
                                                        <div class="single_product">
                                                            ...
                                                            <div class="product_content">
                                                                <span class="product_price">${phone.getPrice()}</span>
                                                                <h3 class="product_title"><a href="single-product.html">${phone.getName()}</a></h3>
                                                            </div>
