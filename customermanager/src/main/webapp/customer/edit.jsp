...
<div class="row">
    <form method="post" class="col-4 offset-3" enctype="multipart/form-data">
        <div class="row mt-2">
            <label class="col-3">Name: </label> <input class="col-9" type="text" name="name"
        ...
        <div class="row mt-2">
            <label class="col-3">Address: </label> <input class="col-9" type="text" name="address"
        ...
        <div class="row mt-2">
            ...
            <select name="sCustomerType" class="col-9 form-control">
                <c:forEach items="${requestScope.customerTypes}" var="ct">
                    <option <c:if test="${ct.getId() == requestScope.customer.getIdType()}"> selected</c:if>
                            value="${ct.getId()}">${ct.getName()}</option>
                </c:forEach>
            </select>
        </div>
        <div class="row mt-2">
            <label class="col-3">Image: </label> <input style="padding-left: 0" class="col-9" id="imgInput" type="file"
                                                        name="image" value="${requestScope.customer.getImage()}">
        </div>
        <div class="row mt-2">
